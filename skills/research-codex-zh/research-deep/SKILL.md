...
- `{validator_path}`: 本机 Codex skills 目录中 `validate_json.py` 的绝对路径，例如 Windows 下为 `C:/Users/<user>/.codex/skills/research/validate_json.py`，Linux/macOS 下为 `/home/<user>/.codex/skills/research/validate_json.py`
